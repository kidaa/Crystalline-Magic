...
import CrystallineMagic.Packets.*;
import CrystallineMagic.Proxies.ServerProxy;
import CrystallineMagic.Spells.SpellComponents.*;
...
import CrystallineMagic.Spells.SpellTypes.*;
...
public class CrystMagic {
    ...
    public static void RegisterSpellParts(){
        ...
        SpellUtils.RegisterComponents(new Levitation());
