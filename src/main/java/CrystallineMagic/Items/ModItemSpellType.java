...
public class ModItemSpellType extends Item implements ISpellPart {
    ...
    public String getItemStackDisplayName(ItemStack stack)
    {
        ...
        if(stack.getTagCompound() != null) {
            return ("" + StatCollector.translateToLocal(this.getUnlocalizedNameInefficiently(stack) + ".name")).trim() + " " + (stack.getTagCompound().getString("Type"));
        }


        return StatCollector.translateToLocal("items.desc.spellType.blank");
    }
