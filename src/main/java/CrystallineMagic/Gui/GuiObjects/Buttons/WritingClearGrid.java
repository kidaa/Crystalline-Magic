...
public class WritingClearGrid extends GuiButton {

    ResourceLocation res = new ResourceLocation("crystmagic", "textures/gui/icons.png");

    public WritingClearGrid(int p_i1021_1_, int p_i1021_2_, int p_i1021_3_) {
    ...
    public void drawButton(Minecraft mc, int p_146112_2_, int p_146112_3_)
    {
        if (this.visible)
        {
            ...
            drawTexturedModalRect(xPosition + 1, yPosition + 1, 65,1, 14,14);
